...
options = {
  ...
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 0, -- LiDAR  scan 사용 안 함
  num_multi_echo_laser_scans = 0,
  num_subdivisions_per_laser_scan = 1,
  num_point_clouds = 1, -- velodyne_points
  publish_to_tf = true,
  ...
  odometry_sampling_ratio= 1., --0.2에서 0.8로 수정함.
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 65
